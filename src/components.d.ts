...
} from "./components/tabworthy-dates/tabworthy-dates";
import {
  DatesCalendarLabels,
...
declare namespace LocalJSX {
  ...
  interface TabworthyDates {
    ...
    onErrorChange?: (
      event: TabworthyDatesCustomEvent<ErrorChangeEventDetails>
    ) => void;
    onSelectDate?: (
  ...
  interface TabworthyTimes {
    ...
    onErrorChange?: (
      event: TabworthyTimesCustomEvent<ErrorChangeEventDetails1>
    ) => void;
    onSelectDateTime?: (
