...
const InclusiveTimes = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'e049ca8df298088e704f6baf200bab775a486c22', class: this.elementClassName, "has-error": this.errorState, disabled: this.disabledState }, index.h("label", { key: '241ac63dc3d804457e3e5e14c3d7818b9592c581', htmlFor: `${this.id}-input`, class: this.getClassName("label") }, this.label), index.h("div", { key: 'f18e007c9ec383f75ea34d29c9ee03216ee86bf4', class: this.getClassName("input-container") }, index.h("input", { key: '99da2013aa8b86f717e8a6e9f94f86cf15062721', id: `${this.id}-input`, ref: (r) => (this.inputRef = r), type: "text", class: this.getClassName("input"), placeholder: this.placeholder, disabled: this.disabledState || this.disableFreeformInput, value: (_a = this.internalValue) === null || _a === void 0 ? void 0 : _a.toString(), onBlur: this.handleInputBlur, onChange: this.handleInputChange, "aria-describedby": this.errorState ? `${this.id}-error` : undefined, "aria-invalid": this.errorState }), !this.inline && (index.h("button", { key: 'c122ddd762f648f63c7b3d942b7bde858bbfdca9', type: "button", ref: (r) => (this.calendarButtonRef = r), onClick: this.handleCalendarButtonClick, class: this.getClassName("calendar-button"), disabled: this.disabledState }, this.calendarButtonContent ? (index.h("span", { innerHTML: this.calendarButtonContent })) : (this.timesLabels.openCalendar)))), index.h("tabworthy-dates-modal", { key: 'b5aacee01555fb5b2503421555b280a71ddabba5', label: this.timesLabels.calendar, ref: (el) => (this.modalRef = el), onOpened: () => {
                if (this.pickerRef) {
            ...
            }, inline: this.inline }, index.h("div", { key: '4d9b8dc721d56ea3e9123151058a149c5dfbb109', class: this.getClassName("picker-container") }, index.h("tabworthy-dates-calendar", { key: '5f6f874feb06b72e0d0774bfe26ba3005c285033', range: this.range, locale: this.locale, onSelectDate: (event) => this.handlePickerSelection(event.detail), onChangeMonth: (event) => this.handleChangedMonths(event.detail), onChangeYear: (event) => this.handleYearChange(event.detail), labels: this.datesCalendarLabels, ref: (el) => (this.pickerRef = el), startDate: this.startDate, firstDayOfWeek: this.firstDayOfWeek, showHiddenTitle: true, disabled: this.disabledState, showMonthStepper: this.showMonthStepper, showYearStepper: this.showYearStepper, showClearButton: this.showClearButton, showTodayButton: this.showTodayButton, disableDate: this.disableDate, minDate: this.minDate, maxDate: this.maxDate, inline: this.inline }, index.h("div", { key: '7cd02c57b4af45caaaa6da7899697d4ea6f35e60', slot: "after-calendar", class: this.getClassName("time-section") }, index.h("hr", { key: '56f2cb3676b2001252ec4960f6ec4931fa451d29', class: this.getClassName("divider") }), index.h("tabworthy-times-picker", { key: '300a3c17e2fd25aa37ca75cb287e28dfb41f3ccd', hours: this.selectedHours, minutes: this.selectedMinutes, use12HourFormat: this.use12HourFormat, disabled: this.disabledState, onTimeChanged: this.handleTimeChange }))))), this.errorState && (index.h("div", { key: '96803190678fb12f4ed5f4ad5a28a29ab98c0c66', class: this.getClassName("input-error"), id: this.id ? `${this.id}-error` : undefined, role: "status" }, this.errorMessage))));
    }
