...
const InclusiveTimes = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '50d45c4b42629ab4db986c798de53bffcfb94018', class: this.elementClassName, "has-error": this.errorState, disabled: this.disabledState }, index.h("label", { key: '9b97b3a86a29629b5acef900cd46c12401a0ed15', htmlFor: `${this.id}-input`, class: this.getClassName("label") }, this.label), index.h("div", { key: '84e4b339f17a14b036e08c3ed55c28ebf8ff1eef', class: this.getClassName("input-container"), ref: (r) => (this.inputContainerRef = r) }, index.h("input", { key: 'f189b9624b1e7a9d80a71dbdbcadc606d4e8c431', id: `${this.id}-input`, ref: (r) => (this.inputRef = r), type: "text", class: {
                [this.getClassName("input")]: true,
                [this.inputClass]: !!this.inputClass
            }, placeholder: this.placeholder, disabled: this.disabledState || this.disableFreeformInput, value: (_a = this.internalValue) === null || _a === void 0 ? void 0 : _a.toString(), onBlur: this.handleInputBlur, onChange: this.handleInputChange, "aria-describedby": this.errorState ? `${this.id}-error` : undefined, "aria-invalid": this.errorState }), !this.inline && (index.h("button", { key: 'dc54c9ff8d4fab01d6175584320de0a0b8282cb2', type: "button", onClick: this.handleCalendarButtonClick, class: this.getClassName("calendar-button"), disabled: this.disabledState }, this.calendarButtonContent ? (index.h("span", { innerHTML: this.calendarButtonContent })) : (this.timesLabels.openCalendar)))), index.h("tabworthy-dates-modal", { key: '1102460f03ffbd9dd3878376fc37fe19aaa50f54', label: this.timesLabels.calendar, ref: (el) => (this.modalRef = el), onOpened: () => {
                if (this.pickerRef) {
            ...
            }, inline: this.inline, appendTo: this.appendTo }, index.h("div", { key: 'fbce75861b31c85a58055eb4dc1c3f9ad0d0be73', class: this.getClassName("picker-container") }, index.h("tabworthy-dates-calendar", { key: '265ab52d552985fddd4c6944fb2405baadae1450', range: this.range, locale: this.locale, onSelectDate: (event) => this.handlePickerSelection(event.detail), onChangeMonth: (event) => this.handleChangedMonths(event.detail), onChangeYear: (event) => this.handleYearChange(event.detail), labels: this.datesCalendarLabels, ref: (el) => (this.pickerRef = el), startDate: this.startDate, firstDayOfWeek: this.firstDayOfWeek, showHiddenTitle: true, disabled: this.disabledState, showMonthStepper: this.showMonthStepper, showYearStepper: this.showYearStepper, showClearButton: this.showClearButton, showTodayButton: this.showTodayButton, disableDate: this.disableDate, minDate: this.minDate, maxDate: this.maxDate, inline: this.inline, value: this.value ? this.toDate(this.value) : undefined }, index.h("div", { key: 'f7377b3ff5a818849afcab7297a6f3d732dd4b82', slot: "after-calendar", class: this.getClassName("time-section") }, index.h("hr", { key: 'd71bc64c57fc8073e4af045347f9be69e20bac9f', class: this.getClassName("divider") }), index.h("tabworthy-times-picker", { key: '2ee95db049c3a81b26fa38b9bb4288f0850dc25f', hours: this.selectedHours, minutes: this.selectedMinutes, useTwelveHourFormat: this.useTwelveHourFormat, disabled: this.disabledState, onTimeChanged: this.handleTimeChange, labels: this.timesPickerLabels }))))), this.errorState && (index.h("div", { key: '0b0f79267ba191582d5e23be27970b16db80aab7', class: this.getClassName("input-error"), id: this.id ? `${this.id}-error` : undefined, role: "status" }, this.errorMessage))));
    }
