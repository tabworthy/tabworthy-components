...
const TabworthyTimesPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '372c9246a2607ae7553b61ba7445086000193ed1', class: this.elementClassName, "aria-label": this.labels.timePicker }, index.h("div", { key: 'fc8ea016f0c0cef3496024285fada802395011ac', class: `${this.elementClassName}__container` }, index.h("div", { key: '235d60b72a515d2b935a736bef6768b057714a53', class: `${this.elementClassName}__field` }, index.h("label", { key: '9f9c5cfee7fb8a44d9b4902809805b5aa2568f18', htmlFor: `${this.elementClassName}-hours`, class: {
                [`${this.elementClassName}__label`]: true,
                [`${this.elementClassName}__label--sr-only`]: this.labelsSrOnly
            } }, this.labels.hours), index.h("div", { key: 'c5e369d24840f55c994d8a546bcca3569e2619ef', class: `${this.elementClassName}__control` }, index.h("button", { key: '51f6278e8af5d4ec0b6ad11e2e1b90ec642adb08', type: "button", class: `${this.elementClassName}__button ${this.elementClassName}__button--increment`, onClick: this.handleHourIncrement, disabled: this.disabled, "aria-label": this.labels.incrementHours }, index.h("svg", { key: '2bd03474f449be514d4a83e00606d476120d7bae', fill: "none", height: "16", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "16" }, index.h("polyline", { key: 'c50112d7748c97e93e4fa0a567ef2a74609e295b', points: "18 15 12 9 6 15" }))), index.h("input", { key: 'a157d44b72d46e6e67b91ac8d00caa5f8df046e7', id: `${this.elementClassName}-hours`, type: "number", class: `${this.elementClassName}__input`, value: this.padZero(displayHours), min: minHours, max: maxHours, onInput: this.handleHourChange, disabled: this.disabled, "aria-label": this.labels.hours }), index.h("button", { key: '63a18713421f84b35b8a9bcef4c10213086bab8e', type: "button", class: `${this.elementClassName}__button ${this.elementClassName}__button--decrement`, onClick: this.handleHourDecrement, disabled: this.disabled, "aria-label": this.labels.decrementHours }, index.h("svg", { key: '3e6c61c533b9ae91d1f35d424c54602b5bd1252c', fill: "none", height: "16", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "16" }, index.h("polyline", { key: 'cfe2fe7edfc882bd03ffbb1c7a282b73afac42ac', points: "6 9 12 15 18 9" }))))), index.h("div", { key: 'e1956c2fa548d3e011ec7a9f88f837e8482280b2', class: `${this.elementClassName}__separator` }, ":"), index.h("div", { key: '6e8292b63371a4a37fb6afca9a3668e87d583fde', class: `${this.elementClassName}__field` }, index.h("label", { key: '876283ccffdce8688ac400d4c46d7f99735da14a', htmlFor: `${this.elementClassName}-minutes`, class: {
                [`${this.elementClassName}__label`]: true,
                [`${this.elementClassName}__label--sr-only`]: this.labelsSrOnly
            } }, this.labels.minutes), index.h("div", { key: 'afdfa8c592b9b90c62fd1fb77a2494977f4edcd2', class: `${this.elementClassName}__control` }, index.h("button", { key: '06d2051e46aa19299ce8a59fe0d474d26f905ed9', type: "button", class: `${this.elementClassName}__button ${this.elementClassName}__button--increment`, onClick: this.handleMinuteIncrement, disabled: this.disabled, "aria-label": this.labels.incrementMinutes }, index.h("svg", { key: '28e6fda7aeb3246e639c0e5e76853576815c1fd1', fill: "none", height: "16", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "16" }, index.h("polyline", { key: '43df9c8fcfc53ff8ebbd0879abd4d1ebc056b9ba', points: "18 15 12 9 6 15" }))), index.h("input", { key: '6b2eb0ac1dbe34304f349b4780e0ae9553cf955d', id: `${this.elementClassName}-minutes`, type: "number", class: `${this.elementClassName}__input`, value: this.padZero(this.internalMinutes), min: 0, max: 59, onInput: this.handleMinuteChange, disabled: this.disabled, "aria-label": this.labels.minutes }), index.h("button", { key: '65e5c108a5cd0451512a1d6c717d1176092e7efb', type: "button", class: `${this.elementClassName}__button ${this.elementClassName}__button--decrement`, onClick: this.handleMinuteDecrement, disabled: this.disabled, "aria-label": this.labels.decrementMinutes }, index.h("svg", { key: 'fb53625bccc3aef8447e70bf7c7b00bc7df03830', fill: "none", height: "16", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "16" }, index.h("polyline", { key: 'ee6274f6d2035243412e992ceec7ae7aecf8793f', points: "6 9 12 15 18 9" }))))), this.showSeconds && [
            index.h("div", { key: '3ee853ccf77f36e4937736a1451eaaaf4aae1ba9', class: `${this.elementClassName}__separator` }, ":"),
            index.h("div", { key: 'ea499addc6e546945a9b9c835793c3f7485f1410', class: `${this.elementClassName}__field` }, index.h("label", { key: 'b63a52658e5ddd90615668be5dc2e457e8217cd9', htmlFor: `${this.elementClassName}-seconds`, class: {
                    [`${this.elementClassName}__label`]: true,
                    [`${this.elementClassName}__label--sr-only`]: this.labelsSrOnly
                } }, this.labels.seconds), index.h("div", { key: 'b812f8b2f952f7da2bfd20b4e8daf0f346dfd10e', class: `${this.elementClassName}__control` }, index.h("button", { key: 'a62b3ef2176f5ffd75ee32335c86e65d549f2ba4', type: "button", class: `${this.elementClassName}__button ${this.elementClassName}__button--increment`, onClick: this.handleSecondIncrement, disabled: this.disabled, "aria-label": this.labels.incrementSeconds }, index.h("svg", { key: 'd12fd6645379007b36692b1a2de07d8dd33687a4', fill: "none", height: "16", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "16" }, index.h("polyline", { key: 'ef1d5818d98c0c35d7b6317f6ee952d13b0c1d33', points: "18 15 12 9 6 15" }))), index.h("input", { key: '68b25324d43824686b933ad9f83d58eb4d71bb0d', id: `${this.elementClassName}-seconds`, type: "number", class: `${this.elementClassName}__input`, value: this.padZero(this.internalSeconds), min: 0, max: 59, onInput: this.handleSecondChange, disabled: this.disabled, "aria-label": this.labels.seconds }), index.h("button", { key: 'fa0fa372e836f05964a5ccb60ed1e8a235e24d8b', type: "button", class: `${this.elementClassName}__button ${this.elementClassName}__button--decrement`, onClick: this.handleSecondDecrement, disabled: this.disabled, "aria-label": this.labels.decrementSeconds }, index.h("svg", { key: '2af2b80fe0853cc908e4eeccbfa4b99c758df941', fill: "none", height: "16", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "16" }, index.h("polyline", { key: 'b4c2c5729a9c0fd129371a17e23026f975dd296a', points: "6 9 12 15 18 9" })))))
        ], this.useTwelveHourFormat && (index.h("div", { key: '6ad19983d00af5cca81dc8753791116e07f98cd1', class: `${this.elementClassName}__period` }, index.h("button", { key: '05817e47857832d21380a425ccf149f9d10a328a', type: "button", class: {
                [`${this.elementClassName}__period-button`]: true,
                [`${this.elementClassName}__period-button--active`]: this.period === "AM"
            }, onClick: () => this.handlePeriodChange("AM"), disabled: this.disabled, "aria-label": this.labels.am, "aria-pressed": this.period === "AM" }, this.labels.am), index.h("button", { key: '7cff09015ab14acb9d40bd8a5d2f249f84d763b8', type: "button", class: {
                [`${this.elementClassName}__period-button`]: true,
