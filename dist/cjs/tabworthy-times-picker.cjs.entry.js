...
const TabworthyTimesPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c307a1b94d1ec25702c286c7f36e4746df8c6bb7', class: this.elementClassName, "aria-label": this.labels.timePicker }, index.h("div", { key: 'c446911a0ddcb6282ab5507d359d56a42f533db3', class: `${this.elementClassName}__container` }, index.h("div", { key: '302c7e7e0c1bf71629ef2a71bb564f9571aad7be', class: `${this.elementClassName}__field` }, index.h("label", { key: '8ce64af4f416c3cdc0dd8943fc02ab9016d62099', htmlFor: `${this.elementClassName}-hours`, class: {
                [`${this.elementClassName}__label`]: true,
                [`${this.elementClassName}__label--sr-only`]: this.labelsSrOnly
            } }, this.labels.hours), index.h("div", { key: '3f541e096c7bb3f436f358800588d5da7fccb34e', class: `${this.elementClassName}__control` }, index.h("button", { key: '31039ad972122c2a6f963190d38f379bb7dce71f', type: "button", class: `${this.elementClassName}__button ${this.elementClassName}__button--increment`, onClick: this.handleHourIncrement, disabled: this.disabled || this.isAtMaxHour(), "aria-label": this.labels.incrementHours }, index.h("svg", { key: '4b16f261f4fecc91973d858b6235fc8aac4f7605', fill: "none", height: "16", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "16" }, index.h("polyline", { key: 'fe60640cfa75911b862913a3076cbeea037a38f7', points: "18 15 12 9 6 15" }))), index.h("input", { key: 'a3a7eed2efc8b1789de698771e82e3f31f50e885', id: `${this.elementClassName}-hours`, ref: (el) => (this.hoursInputRef = el), type: "number", class: `${this.elementClassName}__input`, value: this.padZero(displayHours), min: minHours, max: maxHours, onInput: this.handleHourChange, disabled: this.disabled, "aria-label": this.labels.hours }), index.h("button", { key: '421b70976c21b2b33e21962780d13609a6b762a5', type: "button", class: `${this.elementClassName}__button ${this.elementClassName}__button--decrement`, onClick: this.handleHourDecrement, disabled: this.disabled || this.isAtMinHour(), "aria-label": this.labels.decrementHours }, index.h("svg", { key: 'ab87c0de149d43edcbebd1b2d4d00e4a3ebed5b3', fill: "none", height: "16", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "16" }, index.h("polyline", { key: '32f2d112c44434249d506d1e8222e25b34fb0d44', points: "6 9 12 15 18 9" }))))), index.h("div", { key: '54449a42e67f6f3c2318310bc12eeba24cebc56f', class: `${this.elementClassName}__separator` }, ":"), index.h("div", { key: 'f65d84751223424c3649d0fb9589cf3c1af091eb', class: `${this.elementClassName}__field` }, index.h("label", { key: '911244fd360371ee26b97eb9690c7b04340d6e88', htmlFor: `${this.elementClassName}-minutes`, class: {
                [`${this.elementClassName}__label`]: true,
                [`${this.elementClassName}__label--sr-only`]: this.labelsSrOnly
            } }, this.labels.minutes), index.h("div", { key: 'e5574834dd59e9c08dcee56b07bf8bf186f7ba4b', class: `${this.elementClassName}__control` }, index.h("button", { key: '2b091d643aa785b8ddeae55dd8c523cd5282719d', type: "button", class: `${this.elementClassName}__button ${this.elementClassName}__button--increment`, onClick: this.handleMinuteIncrement, disabled: this.disabled || this.isAtMaxMinute(), "aria-label": this.labels.incrementMinutes }, index.h("svg", { key: '23668a0f1299f86901d0e32e9f7f37bacd376665', fill: "none", height: "16", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "16" }, index.h("polyline", { key: '7f030c2d35147651ad86352c65dc6f8f00b2ba93', points: "18 15 12 9 6 15" }))), index.h("input", { key: 'b73ed30b3a7d25ef84bab23afa45172ce5d03944', id: `${this.elementClassName}-minutes`, type: "number", class: `${this.elementClassName}__input`, value: this.padZero(this.internalMinutes), min: 0, max: 59, onInput: this.handleMinuteChange, disabled: this.disabled, "aria-label": this.labels.minutes }), index.h("button", { key: '7ce7a36ef59e44afd474c427250adc352a8a6694', type: "button", class: `${this.elementClassName}__button ${this.elementClassName}__button--decrement`, onClick: this.handleMinuteDecrement, disabled: this.disabled || this.isAtMinMinute(), "aria-label": this.labels.decrementMinutes }, index.h("svg", { key: '49bcd0c73fde1f77c0d42978a76086abb5be6cc4', fill: "none", height: "16", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "16" }, index.h("polyline", { key: 'c503c319467e0aac6883db25b7d84a1d752aeaf9', points: "6 9 12 15 18 9" }))))), this.showSeconds && [
            index.h("div", { key: 'be25b2045f9e74b0414e55f8d508f7c192e1772e', class: `${this.elementClassName}__separator` }, ":"),
            index.h("div", { key: '85ceb01427ea52c231f1b6a3d78c95c6d603215c', class: `${this.elementClassName}__field` }, index.h("label", { key: '1a1adf9081b3e763e4fbc45b8bab812ae869edbb', htmlFor: `${this.elementClassName}-seconds`, class: {
                    [`${this.elementClassName}__label`]: true,
                    [`${this.elementClassName}__label--sr-only`]: this.labelsSrOnly
                } }, this.labels.seconds), index.h("div", { key: 'abce976c9d3143819c41ff64b54dfbcea41ddd88', class: `${this.elementClassName}__control` }, index.h("button", { key: '1416ee09b69a6d62d8ecd1394bb375fc01601e4a', type: "button", class: `${this.elementClassName}__button ${this.elementClassName}__button--increment`, onClick: this.handleSecondIncrement, disabled: this.disabled || this.isAtMaxSecond(), "aria-label": this.labels.incrementSeconds }, index.h("svg", { key: '1ab4adae2efa4a54286605be221cf2d424e98deb', fill: "none", height: "16", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "16" }, index.h("polyline", { key: '61ef61c721a39732a3aacdc9db5b63950796706b', points: "18 15 12 9 6 15" }))), index.h("input", { key: 'd5b40cf419b007e28f7f69ffe333601fcc3c701e', id: `${this.elementClassName}-seconds`, type: "number", class: `${this.elementClassName}__input`, value: this.padZero(this.internalSeconds), min: 0, max: 59, onInput: this.handleSecondChange, disabled: this.disabled, "aria-label": this.labels.seconds }), index.h("button", { key: '177306df5ba004bbd58df462a7d010f8903656eb', type: "button", class: `${this.elementClassName}__button ${this.elementClassName}__button--decrement`, onClick: this.handleSecondDecrement, disabled: this.disabled || this.isAtMinSecond(), "aria-label": this.labels.decrementSeconds }, index.h("svg", { key: '971169fce6fee5ccb8241faef04d633a0396e347', fill: "none", height: "16", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "16" }, index.h("polyline", { key: '4c31a4b794cc6b421e8e2b3cdb322d584fe40e81', points: "6 9 12 15 18 9" })))))
        ], this.useTwelveHourFormat && (index.h("div", { key: 'b6e9916c6d14aaac6aa3ee1f1c3bd2624f01a344', class: `${this.elementClassName}__period` }, index.h("button", { key: 'c476a13007f840b5f9e5f058623b1846b33b72cf', type: "button", class: {
                [`${this.elementClassName}__period-button`]: true,
                [`${this.elementClassName}__period-button--active`]: this.period === "AM"
            }, onClick: () => this.handlePeriodChange("AM"), disabled: this.disabled, "aria-label": this.labels.am, "aria-pressed": this.period === "AM" }, this.labels.am), index.h("button", { key: 'f4cc8df59e07cb53e9b72f376a17e10df357a335', type: "button", class: {
                [`${this.elementClassName}__period-button`]: true,
