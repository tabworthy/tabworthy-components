...
const InclusiveDatesModal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '35e8ed14b0108e9cb75782516d070dfb8474b0b2', showing: this.showing, ref: (r) => r && (this.el = r) }, !this.inline && this.showing && (index.h("div", { key: 'fdb64ed8717e2a1620ef2d4ffb21a44d1de03a46', part: "body", ref: (r) => {
                if (r) {
                    this.bodyRef = r;
            ...
            }, style: { visibility: this.positioned ? "visible" : "hidden" }, onKeyDown: this.onKeyDown, role: "dialog", tabindex: -1, "aria-hidden": !this.showing, "aria-label": this.label, "aria-modal": this.showing }, index.h("focus-trap", { key: 'af4734b1a18dd62a600ca49313b1ba07f2d19039' }, index.h("div", { key: 'fb41d5ce07b5aac179e4bed63c18a8d254503a50', part: "content" }, index.h("slot", { key: 'fc480cf1a29a42b1a19737a72d410c139dc32f07' }))))), this.inline && (index.h("div", { key: '7aef10d50f790a1e72e05b26dc108c40500fa7c3', part: "content" }, index.h("slot", { key: '06395cd19052d1b81ab448c0a9a618da876fa86d' })))));
    }
