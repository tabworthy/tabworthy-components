...
const TabworthyDatesCalendar = class {
    ...
    getCalendarRows() {
        ...
        while (calendarRows.length < 6 && lastDay) {
            const row = [];
            for (let i = 0; i < 7; i += 1) {
                lastDay = utils.addDays(lastDay, 1);
                row.push(lastDay);
            }
            calendarRows.push(row);
        }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '60e2a56f8a1aadceb57d7f445098060293a0f937' }, index.h("div", { key: '12fd35c03b0c34e4ad88e4e491fcc685de5f09b2', class: {
            ...
            } }, index.h("div", { key: '181b9ed0a6a9d6073d67f270d6b14efc28f6a6b2', class: this.getClassName("header") }, this.showHiddenTitle && (index.h("span", { key: '580656924dc3ba028458591399791423797d58d7', "aria-atomic": "true", "aria-live": "polite", class: "visually-hidden" }, this.getTitle())), this.showYearStepper && (index.h("button", { key: 'baedceb7e568df8bfc1cee64d13c6114b85c3764', "aria-label": this.labels.previousYearButton, class: this.getClassName("previous-year-button"), "aria-disabled": String(disabled.year.prev), disabled: disabled.year.prev, innerHTML: this.previousYearButtonContent || undefined, onClick: this.previousYear, type: "button" }, index.h("svg", { key: '4e3286e12ebd5c5bba8dfc3f0ecab29f37ddf9c0', fill: "none", height: "24", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "24" }, index.h("polyline", { key: '6178bb5e4dc08a9b46c587c7b3e7c5fd27867f5b', points: "11 17 6 12 11 7" }), index.h("polyline", { key: '3d03d26acc37c91243d7cbd54d228f35752f80a7', points: "18 17 13 12 18 7" })))), this.showMonthStepper && (index.h("button", { key: '9ecb2f9e5adceda9526b15b64721f16e1c7a8ca5', "aria-label": this.labels.previousMonthButton, class: this.getClassName("previous-month-button"), "aria-disabled": String(disabled.month.prev), disabled: disabled.month.prev, innerHTML: this.previousMonthButtonContent || undefined, onClick: this.previousMonth, type: "button" }, index.h("svg", { key: 'a8c74b97c18cae04b86464a53b8a99f3cffd1379', fill: "none", height: "24", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "24" }, index.h("polyline", { key: '196da2b5f0485a8af41232b2c9fd614e131230e6', points: "15 18 9 12 15 6" })))), index.h("span", { key: 'b044b7041af2cbd6b527b05b6d4175e85a4a5e0c', class: this.getClassName("current-month") }, index.h("select", { key: 'f4259d0b1448b19e861ed1bb7401508b6e8f5505', "aria-label": this.labels.monthSelect, class: this.getClassName("month-select"), "aria-disabled": this.disabled, name: "month", onChange: this.onMonthSelect }, utils.getMonths(this.locale).map((month, index$1) => {
        ...
        })), index.h("input", { key: '29566d4d17a43313d0cd09102ffe8f7dadab48a4', "aria-label": this.labels.yearSelect, class: this.getClassName("year-select"), "aria-disabled": this.disabled, max: this.maxDate ? this.maxDate.slice(0, 4) : 9999, min: this.minDate ? this.minDate.slice(0, 4) : 1, name: "year", onChange: this.onYearSelect, type: "number", value: this.currentDate.getFullYear() })), this.showMonthStepper && (index.h("button", { key: '3c3a08d8c1a9471d3c03656e1c69dd9b610964a6', "aria-label": this.labels.nextMonthButton, class: this.getClassName("next-month-button"), "aria-disabled": String(disabled.month.next), disabled: disabled.month.next, innerHTML: this.nextMonthButtonContent || undefined, onClick: this.nextMonth, type: "button" }, index.h("svg", { key: '691056b81918999f8cb5e411ea808bfc3d63d285', fill: "none", height: "24", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "24" }, index.h("polyline", { key: '1ad9ffac020a5e77bfbe13e56be4039c0ab1bce1', points: "9 18 15 12 9 6" })))), this.showYearStepper && (index.h("button", { key: '541f139687c50d4515f6ba52f86e5bd0dfb480a8', "aria-label": this.labels.nextYearButton, class: this.getClassName("next-year-button"), "aria-disabled": String(disabled.year.next), disabled: disabled.year.next, innerHTML: this.nextYearButtonContent || undefined, onClick: this.nextYear, type: "button" }, index.h("svg", { key: '38ed3c8a59612395ef641d3ae1068f755f7d68b1', fill: "none", height: "24", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "24" }, index.h("polyline", { key: '2b95dc3f77f314e84d2cfaec8e479d7097ab43d9', points: "13 17 18 12 13 7" }), index.h("polyline", { key: 'f26e6b1290a4817aef45fb8e7aa0f7956fefaa8c', points: "6 17 11 12 6 7" }))))), index.h("div", { key: '2c8eefeaac7909a66bd3975c4a5be18ac7f459fe', class: this.getClassName("body") }, index.h("table", { key: '2a3646bac9db5b7253fa17632d71d74bec41a6ee', class: this.getClassName("calendar"), onKeyDown: this.onKeyDown, role: "grid", "aria-label": this.getTitle() }, index.h("thead", { key: '146348c0e34687eb6b776698b8dd8eba44b51552', class: this.getClassName("calendar-header") }, index.h("tr", { key: 'afa9189bdbaab542fdf36c78849da38cdf387135', class: this.getClassName("weekday-row") }, (_a = this.weekdays) === null || _a === void 0 ? void 0 : _a.map((weekday) => (index.h("th", { role: "columnheader", abbr: weekday[1], class: this.getClassName("weekday"), key: weekday[0], scope: "col" }, index.h("span", { "aria-hidden": "true" }, weekday[0]), index.h("span", { class: "visually-hidden" }, weekday[1])))))), index.h("tbody", { key: 'd70b0012e308a5dadb5da96c78f6471253f9d1c0' }, this.getCalendarRows().map((calendarRow) => {
        ...
        })))), showFooter && (index.h("div", { key: '574bd94d669e65194e7c26499007a320d950dff4', class: this.getClassName("footer") }, index.h("div", { key: 'c4fad38c1c3a57f221c3b7094e1f70981fcd9f65', class: this.getClassName("footer-buttons") }, this.showTodayButton && (index.h("button", { key: '26e4889dc3d806204df07aea74069741dc8794d9', "aria-label": this.todayButtonContent
                ? this.labels.todayButton
                : undefined, class: this.getClassName("today-button"), disabled: this.disabled, innerHTML: this.todayButtonContent || undefined, onClick: this.showToday, type: "button" }, !this.todayButtonContent && this.labels.todayButton)), this.showClearButton && (index.h("button", { key: '347741d4adfc95c14060864de7674344da311a6e', "aria-label": this.clearButtonContent
                ? this.labels.clearButton
                : undefined, class: this.getClassName("clear-button"), disabled: this.disabled, innerHTML: this.clearButtonContent || undefined, onClick: this.clear, type: "button" }, !this.clearButtonContent && this.labels.clearButton)), this.showCloseButton && (index.h("button", { key: '287053ef376238a807a1ff092da80a350700abd2', "aria-label": this.closeButtonContent
            ...
            !window.matchMedia("(pointer: coarse)").matches && (index.h("button", { key: 'bb05e75930b211fb43874b492c4e16229d0d7232', type: "button", onClick: () => alert("Todo: Add Keyboard helper!"), class: this.getClassName("keyboard-hint") }, index.h("svg", { key: '8b7e648ea409ce84086aaf06c4d4707dd6e09274', xmlns: "http://www.w3.org/2000/svg", height: "1em", width: "1em", viewBox: "0 0 48 48", fill: "currentColor" }, index.h("path", { key: 'aeaefade16771c198b74bb1c38f88bd9457d2baa', d: "M7 38q-1.2 0-2.1-.925Q4 36.15 4 35V13q0-1.2.9-2.1.9-.9 2.1-.9h34q1.2 0 2.1.9.9.9.9 2.1v22q0 1.15-.9 2.075Q42.2 38 41 38Zm0-3h34V13H7v22Zm8-3.25h18v-3H15Zm-4.85-6.25h3v-3h-3Zm6.2 0h3v-3h-3Zm6.15 0h3v-3h-3Zm6.2 0h3v-3h-3Zm6.15 0h3v-3h-3Zm-24.7-6.25h3v-3h-3Zm6.2 0h3v-3h-3Zm6.15 0h3v-3h-3Zm6.2 0h3v-3h-3Zm6.15 0h3v-3h-3ZM7 35V13v22Z" })), this.labels.keyboardHint))))), index.h("slot", { key: '6054a85ed3973b573f102c45d33995ad90eaf2f8', name: "after-calendar" }))));
    }
